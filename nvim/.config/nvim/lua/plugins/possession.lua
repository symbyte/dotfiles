return {
  {
    ...
    keys = {
      ...
      { "<leader>sns", "<cmd>SSave<cr>", desc = "save session" },
      { "<leader>snl", "<cmd>SLoad<cr>", desc = "load session" },
      { "<leader>snc", "<cmd>SClose<cr>", desc = "close session" },
      { "<leader>snd", "<cmd>SDelete<cr>", desc = "delete session" },
    },
  },
